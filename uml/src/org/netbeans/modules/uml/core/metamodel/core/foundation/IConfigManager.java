...
public interface IConfigManager
{
	...
	*/
	 ...
	 * Retrieves the absolute path to the Presentation types etc file.
	*/
	void setPresentationTypesLocation(String value);
	...
	*/
	 ...
	 * Retrieves the absolute path to the stereotype icons etc file.
	*/
	void setStereotypeIconsLocation(String value);
	...
	*/
	 ...
	 * Retrieves the absolute path to the Event framework .etc file.
	*/
	void setEventFrameworkLocation(String value);
	...
	*/
	 ...
	 * Retrieves the absolute path to the DTD used for all new projects.
	*/
	void setDTDLocation(String value);

	/**
	 * Retrieves an identifying string found in the EssentialConfig.etc file.
	*/
	String getID(String hive, String name);

	/**
	 * Retrieves an identifying string found in the EssentialConfig.etc file.
	*/
	String getIDs(String hive, String name, StringBuffer stdID);
	...
	*/
	 ...
	 * Retrieves the absolute location of the default preferences file.
	*/
	void setPreferenceLocation(String value);
	...
	*/
	...
	void setDefaultResourcesLocation(String newVal);

	String getDefaultResourcesLocation();
	
	void setOverriddenResourcesLocation(String newVal);
