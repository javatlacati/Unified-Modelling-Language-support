...
public class PropertyElements
{
	...
	public PropertyElements(List<IPropertyElement> pProperties)
	{
												...
												boolean bRemoveFromList)
	{
		...
		if (pElement == null)
		{
			...
			for (int i = 0 ; i < count ; i++)
			{
				...
				{
					List<IPropertyElement> pSubElements = pThisElement.getSubElements();
	...
	public ETPairT<ETList<IPropertyElement>, ETList<IPropertyElement> > getColorsAndFonts(boolean bRemoveFromList)
	{
		...
		ETList<Integer> itemsToRemove = new ETArrayList <>();
