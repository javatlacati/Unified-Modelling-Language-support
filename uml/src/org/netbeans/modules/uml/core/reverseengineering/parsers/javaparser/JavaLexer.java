...
public JavaLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("byte", this), 55);
	literals.put(new ANTLRHashString("public", this), 66);
	literals.put(new ANTLRHashString("case", this), 97);
	literals.put(new ANTLRHashString("short", this), 57);
	literals.put(new ANTLRHashString("break", this), 92);
	literals.put(new ANTLRHashString("while", this), 90);
	literals.put(new ANTLRHashString("new", this), 140);
	literals.put(new ANTLRHashString("instanceof", this), 125);
	literals.put(new ANTLRHashString("implements", this), 79);
	literals.put(new ANTLRHashString("synchronized", this), 71);
	literals.put(new ANTLRHashString("float", this), 59);
	literals.put(new ANTLRHashString("package", this), 48);
	literals.put(new ANTLRHashString("return", this), 94);
	literals.put(new ANTLRHashString("throw", this), 96);
	literals.put(new ANTLRHashString("null", this), 139);
	literals.put(new ANTLRHashString("protected", this), 67);
	literals.put(new ANTLRHashString("class", this), 73);
	literals.put(new ANTLRHashString("throws", this), 85);
	literals.put(new ANTLRHashString("do", this), 91);
	literals.put(new ANTLRHashString("strictfp", this), 43);
	literals.put(new ANTLRHashString("super", this), 83);
	literals.put(new ANTLRHashString("transient", this), 69);
	literals.put(new ANTLRHashString("native", this), 70);
	literals.put(new ANTLRHashString("interface", this), 75);
	literals.put(new ANTLRHashString("final", this), 41);
	literals.put(new ANTLRHashString("if", this), 87);
	literals.put(new ANTLRHashString("double", this), 61);
	literals.put(new ANTLRHashString("volatile", this), 72);
	literals.put(new ANTLRHashString("catch", this), 100);
	literals.put(new ANTLRHashString("try", this), 99);
	literals.put(new ANTLRHashString("int", this), 58);
	literals.put(new ANTLRHashString("for", this), 89);
	literals.put(new ANTLRHashString("extends", this), 74);
	literals.put(new ANTLRHashString("boolean", this), 54);
	literals.put(new ANTLRHashString("char", this), 56);
	literals.put(new ANTLRHashString("private", this), 65);
	literals.put(new ANTLRHashString("default", this), 98);
	literals.put(new ANTLRHashString("false", this), 138);
	literals.put(new ANTLRHashString("this", this), 82);
	literals.put(new ANTLRHashString("static", this), 68);
	literals.put(new ANTLRHashString("abstract", this), 42);
	literals.put(new ANTLRHashString("continue", this), 93);
	literals.put(new ANTLRHashString("finally", this), 101);
	literals.put(new ANTLRHashString("else", this), 88);
	literals.put(new ANTLRHashString("import", this), 50);
	literals.put(new ANTLRHashString("void", this), 53);
	literals.put(new ANTLRHashString("switch", this), 95);
	literals.put(new ANTLRHashString("true", this), 137);
	literals.put(new ANTLRHashString("long", this), 60);
}
