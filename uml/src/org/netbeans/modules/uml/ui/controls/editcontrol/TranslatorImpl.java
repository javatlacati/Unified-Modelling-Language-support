...
public class TranslatorImpl implements ITranslator
{
      ...
      if (m_Element != null)
      {
         ...
         if (pFormatter != null)
         {
            ...
            if (m_PropertyElement != null)
            {
               ...
               List subEles = m_PropertyElement.getSubElements();
               if (subEles != null)
               {
                  int count = subEles.size();
                  for (int i=0; i<count; i++)
                  {
                     IPropertyElement pEle = (IPropertyElement)subEles.get(i);
                     addField(pEle, false);
                  }
               }
            }
    ...
    */
   @Override
   public void updateFields(List pElements)
   {
      if (pElements != null)
      {
         ...
         for (int i=0; i<count; i++)
         {
            IPropertyElement subEle = (IPropertyElement)pElements.get(i);
