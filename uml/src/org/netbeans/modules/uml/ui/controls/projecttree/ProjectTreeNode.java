...
public class ProjectTreeNode extends DefaultMutableTreeNode implements ITreeItem {
    ...
    * @see org.netbeans.modules.uml.ui.support.projecttreesupport.ITreeItem#addChild(org.netbeans.modules.uml.ui.support.projecttreesupport.ITreeItem)
     ...
     * If the specified index is greater than the number of children then it is
     * appened to the end of the child list.
     *
    ...
    public Enumeration< ITreeItem> getNodeChildren() {
        return Collections.enumeration(
                Collections.list(children())
                        .stream()
                        .map(treeitem-> (ITreeItem)treeitem)
    ...
    * @see org.netbeans.modules.uml.ui.support.projecttreesupport.ITreeItem#getData()
    ...
    /**
     * Specifies whether or not the node has ever been expanded. If the node has
     * been expanded before then its children has already been set. Otherwise,
     * the node has not been completely initialized yet.
     *
