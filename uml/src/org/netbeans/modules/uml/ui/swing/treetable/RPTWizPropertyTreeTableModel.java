...
public class RPTWizPropertyTreeTableModel implements TreeTableModel {
    ...
    private HashMap < Object, Vector < Object > > m_BuiltChildren = new HashMap<>();

    private Vector < Icon > m_Icons = new Vector<>();
                    ...
                    try {
                        ...
                        if (pDef != null) {
                            ...
                            if (mult > 1) {
                                ...
                                int enumVal = Integer.valueOf(value);
                                ...
                                if (values != null && values.contains("|")) {
                                    ...
                                    while (tokenizer.hasMoreTokens()) {
                                        String token = tokenizer.nextToken();
                                        if (j == enumVal) {
                                            retValue = m_Translator.translate(pDef, token);
                                        }
                                        j++;
                                    }
                                }
