...
public interface ITaskSupervisor
{
    ...
    int SUMMARY = 0; // very high level messages
    int TERSE = 1; // somewhat detailed messages
    int VERBOSE = 2; // very detailed messages
    int DEBUG = 3; // debug level information only

    boolean start(int itemTotal);
    boolean start(int contributor, int itemTotal);
    ...
    void log(int level, String msg, boolean newline);
