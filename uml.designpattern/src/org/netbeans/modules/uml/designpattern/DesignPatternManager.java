        ...
        if (pDetails != null) {
            ...
            if (createDiagram) {
                ...
                if (pDiagManager != null) {
                    ...
                    if (pResult != null) {
                        boolean bIsCorrect = pResult.getParamOne();
                        if (!bIsCorrect) {
...
//                }
    ...
    public boolean clonePropertyElements(IPropertyElement pPropEleDP, IPropertyElement pPropEle) {
        ...
        if (pPropEleDP != null && pPropEle != null) {
            ...
            //
            List<IPropertyElement> pSubsDP = pPropEleDP.getSubElements();
            if (pSubsDP != null) {
                // And get each of the sub elements in the one that is the instance
                List<IPropertyElement> pSubs = pPropEle.getSubElements();
                if (pSubs != null) {
                ...
                if (identifier == null || identifier.length() == 0) {
                    ...
                    if (pKeySub != null) {
                        ...
                        if (pKeySub2 != null) {
                            ...
                            List < IPropertyElement > pSubs = pPropEles.getSubElements();
                ...
                if (pDisp != null) {
                    if (pDisp instanceof IElement) {
                        ...
                        if (pNode != null) {
                            ...
                            //
                            List < IPropertyElement > pSubEles = pPropEles.getSubElements();
        ...
        if (pPropEle != null && pPropEleOrig != null) {
            ...
            if (pKeySub != null) {
                ...
                if (pElementM != null) {
                    ...
                    List <IPropertyElement> pSubs = pPropEleOrig.getSubElements();
                    if (pSubs != null) {
