...
//                System.getProperty("file.encoding")); // NOI18N
        ...
        for (int i=0; i<items.length; i++)
        {
            ...
            if (link!=null)
            {
                ...
                <BR>
                 */
                buff.append("<FONT CLASS=\"FrameItemFont\"><A HREF=\"").append(link).append("\"target=\"packageFrame\">").append(pname).append("</A></FONT><BR>\n"); // NOI18N
            }
        }
...
//                System.getProperty("file.encoding")); // NOI18N
        ...
        if (packages.size()>0)
        {
            ...
            buff.append("<B>").append(projectName).append(" ").append(// NOI18N
                    NbBundle.getMessage(ReportTask.class,"packages")).append("</B></FONT></TH>\n"); // NOI18N
            buff.append("</TR>\n"); // NOI18N
            ...
            for (int i=0; i<items.length; i++)
            {
                ...
                buff.append("<TD WIDTH=\"20%\"><B><A HREF=\"").append(link).append("\">").append(pname).append("</A></B></TD>\n"); // NOI18N
                buff.append("<TD>").append(doc).append("</TD>\n"); // NOI18N
                buff.append("</TR>\n"); // NOI18N
            }
            buff.append("</TABLE>\n"); // NOI18N
        }
    ...
    public static StringBuilder readTemplate(String resource)
    {
        ...
        if (loader!=null)
        {
            if (resource.contains(".html")) // NOI18N
            {
