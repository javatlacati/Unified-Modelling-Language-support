...
//      }  
                                          ...
                                          boolean          autoCommit)
   {
      ...
      List < IPropertyElement > elements = element.getSubElements();
      if(elements != null)
      { 
...
//                        if((value2 == null) || (value2.length() <= 0))
                                                ...
                                                boolean autoCommit)
   {
       ...
       {           
           for (Iterator < IPropertyElement > iter = elements.iterator(); iter.hasNext();)
           {
               ...
               {                   
                   List < IPropertyElement > initialData = curElement.getSubElements();
   ...
   protected void buildPropertySheets(List < IPropertyElement > initialData,
