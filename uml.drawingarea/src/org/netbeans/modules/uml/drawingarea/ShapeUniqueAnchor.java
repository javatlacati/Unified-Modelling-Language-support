...
public final class ShapeUniqueAnchor extends Anchor {
    ...
    private HashMap<Entry, Result> results = new HashMap<>();
    ...
    public void recalculate() {
        ...
        HashMap<Entry, Float> topmap = new HashMap<>();
        HashMap<Entry, Float> bottommap = new HashMap<>();
        HashMap<Entry, Float> leftmap = new HashMap<>();
        HashMap<Entry, Float> rightmap = new HashMap<>();
        ...
        if (bounds == null) {
            ...
            if (!includeBorders) {
                ...
                if (bounds != null) {
                    ...
                    //TODO perhaps needs to specify bounds RLC
                }
            }
